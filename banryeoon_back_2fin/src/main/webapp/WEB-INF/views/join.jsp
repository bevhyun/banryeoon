 ...
 <main>
    ...
    <div class="join_in_box">
         <div class="content_box">
            ...
            <!-- 아이디 -->
                <div class="id">
                    <input type="text" value="1234" placeholder="아이디* (영소문자/숫자, 4~16자)" id="uid" name="userId" autocomplete="new-id" required>
                    <div class="id_msg">아이디를 입력해주세요.</div>
                </div>
                <!-- 비밀번호 -->
                <input type="password" value="1234" placeholder="비밀번호* (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)" class="psw i_type1" name="userPw" autocomplete="new-password" required>
<%--                <input type="password" placeholder="비밀번호 확인*" class="psw_chk i_type1" name="confrim_psw" autocomplete="new-password">--%>

                <!-- 이름 -->
                <input type="text" value="1234" placeholder="이름*" class="u_name i_type1"  name="userName" required>
                ...
                <div class="tele">
                    ...
                    <input type="tel" id="phone2" value="1234" placeholder="전화번호*" maxlength="4" required>
                    <input type="tel" id="phone3" value="1234" maxlength="4" required>
                    <input type="hidden" name="userPhone" id="userPhone">
                </div>

                <!-- 이메일 -->
                <input type="text" value="1234" class="u_email i_type1" name="userEmail" placeholder="이메일*" required>
                ...
                <div class="birthday">
                    <input type="tel" id="birth1" value="1234" maxlength="4" placeholder="년" required> 년
                    <input type="tel" id="birth2" value="12" maxlength="2" placeholder="월" required> 월
                    <input type="tel" id="birth3" value="12" maxlength="2" placeholder="일" required> 일
                    ...
                    <div class="document">
                       ...
                       <div class="docu_2_box db">
                            ...
                            <div class="docu_regulation">
                                <div class="frist">
                                제 1조 (목적)<br>
                               1. 본 약관은 반려온(溫)(이하 "사이트"라 합니다)이 제공하는 유기묘 및 유기견 분양 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 사이트와 회원 간의 권리, 의무 및 책임사항을 규정하는 것을 목적으로 합니다.
                                </div>
                       ...
                       <div class="docu_3_box db">
                            ...
                            <div class="docu_regulation">
                                <div class="frist">
                                제 1조 (서비스 이용)<br>
                                1. 사이트는 회원에게 유기묘 및 유기견의 분양 정보를 제공하며, 이를 위한 중개 서비스만을 제공합니다.<br>
                                2. 서비스 이용자는 분양받고자 하는 유기동물에 대해 필요한 정보를 확인하고, 해당 동물의 보호자와의 소통을 통해 분양 절차를 진행할 수 있습니다.
                                </div>
                       ...
                       <div class="docu_4_box db">
                            ...
                            <div class="docu_regulation">
                                <div class="frist">
                                제 1조 (개인정보 보호)<br>
                                1. 본 페이지는 유기견 및 유기묘 분양 서비스를 제공함에 있어 회원 여러분의 개인정보를 매우 중요하게 생각하며, 「개인정보 보호법」 등 관련 법규를 준수하고 있습니다. 회원가입 시 수집되는 개인정보는 다음과 같으며, 명시된 목적 이외의 용도로는 사용되지 않습니다.
                                </div>
                                ...
                                <div class="second">
                                 ...
                                 1. 회원가입 시 원활한 분양 절차 진행, 분양 관련 정보 제공, 회원제 서비스 이용 및 관리, 본인 확인 등을 위해 다음과 같은 최소한의 개인정보를 필수 항목으로 수집하고 있습니다.
                                </div>
                               ...
                               2. 유기동물 분양 절차 진행 및 관리 (분양 신청 접수, 심사, 상담, 입양 후 확인 등)<br>
                               3. 분양 가능한 동물 정보 제공 및 맞춤 추천<br>
                               4. 분양 관련 공지사항, 알림 등 중요 정보 전달<br>
                       ...
                       <div class="docu_5_box db">
                            ...
                            <div class="docu_regulation">
                                <div class="frist">
                                제 1조 (면책 조항)<br>
                                1. 사이트는 유기동물의 분양과 관련된 모든 과정에서 발생하는 법적 책임을 지지 않습니다. 모든 분양 과정은 보호자와 수용자의 책임 하에 이루어집니다.<br>
