    ...
    <div class="popup">
        ...
        <form action="<c:url value="/login/findId" />" class="layer" method="post" onsubmit="return combineInputs()">
            <div class="find_W_name_box">
                ...
                <input type="text" value="1234" id="f_name" placeholder="이름" name="userName" required>
            </div>
            ...
            <div class="find_W_ph_box" >
                ...
                <input type="tel" value="1234" id="sel2" name="p_middle" class="phone_n_middle"> -
                <input type="tel" value="1234" id="sel3" name="p_last" class="phone_n_last">
...
<div class="popup_overlay_p" id="popupOverlay_p">
    <div class="popup_p">
        ...
        <form action="#" class="layer_p">
            <div class="find_W_id_box">
                <div class="fid_title">아이디</div>
                <input type="text" id="f_id" name="f_uid" >
            </div>

            <div class="find_W_email_box">

                <div class="femail_title">이메일</div>
                <input type="email" name="f_mail" class="f_w_mail">
                <div class="at">@</div>

                <select name="" id="f_email_op" name="f_uemail">
    ...
    <div class="close_btn_box">
        <input type="submit" value="확인" class="close_btn_p" id="closePopup_p">
    </div>
    ...
    <div class="login_box">
        ...
        <form action="<c:url value="/login" />" method="post">
            <div class="id_box">
                ...
                <input type="text" value="1234" id="uid" name="userId" >
            </div>

            <div class="psw_box">
                <div class="id_psw">비밀번호</div>
                <input type="password" value="1234" id="psw" name="userPw">
            ...
            <div class="submit_btn_box">
                <input type="submit" value="기존 회원 로그인" class="submit_btn">
            </div>
