  ...
  <div class="popup">
    ...
    <form action="#" class="layer">
      ...
      <div class="find_W_ph_box">
        ...
        <select id="f_tel_list" name="p_first">
...
<div class="popup_overlay_p" id="popupOverlay_p">
   ...
   <form action="#" class="layer_p">
       ...
       <div class="find_W_email_box">
           ...
           <input type="mail" name="f_mail" class="f_w_mail"> 
           <div class="at">@</div>
        ...
        <div class="login_box">
            ...
            <form action="#">
                <div class="id_box">
                    ...
                    <input type="text" id="uid" name="u_id" >
                </div>

                <div class="psw_box">
                    <div class="id_psw">비밀번호</div>
                    <input type="password" id="psw" name="u_psw">
            ...
            <div class="find_box">
                ...
                <div class="join_box">
                    <div class="join_in"> <a href="/join">회원가입</a></div>
                </div>
            </div>
