...
public class UserDaoImplTest {
    ...
    @Before
    public void setUp() {
        user1 = new UserDto(0, "testuser1", "pw1", "홍길동", "010-1111-1111", "test1@email.com", "1990-01-01");
        user2 = new UserDto(0, "testuser2", "pw2", "이몽룡", "010-2222-2222", "test2@email.com", "1992-02-02");
        userDao.deleteAll();
    }
    ...
    public void updateUser() {
        ...
        UserDto update = new UserDto(0, "testuser1", "newpw", "고길동", "010-3333-3333", "new@email.com", "2000-03-03");
