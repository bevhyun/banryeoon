...
<header>
    ...
    <!-- 메인 로고 이미지 -->
    <div class="h_img_box">
        <img src="<c:url value='/resources/img/banryeoonlogo.png'/>" alt="" class="h_logo_img">
    </div>
</header>
        ...
        <div class="area_box">
            <div class="area_box nav_box">
                <ul class="nav_ul">
                    ...
                    <li class="nav_li">
                        <!-- 제품 구매 페이지 링크 -->
                        <a href="${pageContext.request.contextPath}/product/">제품 구매</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="nav_page">
        <ul class="nav_page_ul">
            ...
            <li class="nav_page_merchan">
                <a href="${pageContext.request.contextPath}/product/animal?type=200">고양이 제품</a>
                <a href="${pageContext.request.contextPath}/product/animal?type=100">강아지 제품</a>
            </li>
        </ul>
    </div>
