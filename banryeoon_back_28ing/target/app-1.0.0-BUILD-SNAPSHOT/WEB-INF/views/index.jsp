        ...
        <div class="nav_page">
            <ul class="nav_page_ul">
                ...
                <li class="nav_page_merchan">
                    <div class="np"><a href="http://localhost:8080/product">고양이 제품</a></div>
                    <div class="np"><a href="http://localhost:8080/product">강아지 제품</a></div>
                </li>
            </ul>
        </div>
            ...
            <div class="swiper mySwiper main_adBanner adBanner2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="swiperimg" src="../../resources/img/swiper91.jpeg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiperimg" src="../../resources/img/swiper92.jpeg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img class="swiperimg" src="../../resources/img/swiper93.jpeg" alt="">
                    </div>
                </div>
