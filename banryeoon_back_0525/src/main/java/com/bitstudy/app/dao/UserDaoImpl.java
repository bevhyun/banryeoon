...
//    ----------------admin----------------------
    ...
    @Override
    public List<AnimalDto> adminsearchPSeqno(int userSeqno) {
        try {
...
//    admin에서 회원관리할때 이름으로 조회하는 방법
    @Override
    public List<AnimalDto> adminsearchPName(String userName) {
        try {
...
//    admin에서 회원관리할때 아이디로 조회하는 방법
    @Override
    public List<AnimalDto> adminsearchPEmail(String userId) {
        try {
