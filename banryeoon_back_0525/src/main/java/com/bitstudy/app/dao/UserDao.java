...
//    String adminsearchPName(UserDto userDto);
    List<AnimalDto> adminsearchPName(@Param("userName") String userName);

//    admin에서 회원관리할때 아이디로 조회하는 방법
//    String adminsearchPId(UserDto userDto);
    List<AnimalDto> adminsearchPEmail(@Param("userEmail") String userEmail);

    // admin에서 회원관리할때 seqno 조회하는 방법
//    int adminsearchPSeqno(UserDto userDto);
    List<AnimalDto> adminsearchPSeqno(@Param("userSeqno") int userSeqno);
