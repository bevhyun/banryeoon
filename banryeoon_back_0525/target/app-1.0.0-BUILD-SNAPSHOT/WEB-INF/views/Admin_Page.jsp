...
<%--        </a>--%>
    ...
    <div class="search_bar">
      <select name="mem_manage" id="userManage">
...
<%--        <button class="search-button">검색</button>--%>
        <input class="search-input" type="text" placeholder="검색어를 입력하세요" value="${param.keyword}">
      ...
      <thead>
        ...
        <c:forEach var="animal" items="${animals}" varStatus="st">
            <tr class="boardBody">
                ...
                <!-- 종류 -->
                <td class="s_breed">
                    <a href="/admin/animal/detail?seq=${animal.aniSeqno}">
                            ${animal.aniBreed}
                    </a>
                </td>
                <!-- 발견지역 -->
...
<%--                              <a href="?page=${i}">${i}</a>--%>
  ...
  <div id="tab4" class="tab-content">
    ...
    <div class="search_bar">
      <select name="board_manage" id="adoptionManage">
        <option value="name">이름</option>
        <option value="region">지역</option>
        <option value="number">seq.no</option>
      </select>
...
<%--                  <a href="/adoption/list/detail?aniSeqno=${animal.aniSeqno}">--%>
                      <li class="thumbnail_li">
                          ...
                          <div class="post_info">
                              <span>${animal.aniSeqno}</span>
                              <span>${animal.aniBreed}</span>
                          </div>
